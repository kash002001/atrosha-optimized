...
\begin{itemize}
    \item Proof generation: $< 500$ms for policies with $\leq 50{,}000$ constraints
    \item Verification: $< 10$ms
    \item Proof size: 256 bytes (constant)
    \item Memory: $< 2$GB during proof generation
\end{itemize}
