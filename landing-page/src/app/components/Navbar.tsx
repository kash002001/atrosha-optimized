...
export default function Navbar() {
    ...
    return (
        <nav className="fixed w-full z-50 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md border-b border-gray-100/60 dark:border-gray-800/40">
